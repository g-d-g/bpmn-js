  ...
  describe('sizing', function() {
    ...
    describe('width', function() {
      ...
      describe('text annotation', function() {
        ...
        it('[no text] should have min width', testTextboxSizing('text-annotation', 1, 106, 32));

        it('[one word] should have min width', testTextboxSizing('text-annotation', 1, 106, 32, oneWord));

        it('[five words] should expand width', testTextboxSizing('text-annotation', 1, { min: 176 }, 32, fiveWords));

        it('[long word] should expand width', testTextboxSizing('text-annotation', 1, { min: 129 }, 32, longWord));
